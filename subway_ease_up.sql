...
CREATE TABLE `carriage_info` (
  ...
  `cid` int(5) NOT NULL,
  `cNo` int(3) NOT NULL,
  `pNum` int(4) NOT NULL DEFAULT 0,
  `air` int(4) NOT NULL DEFAULT 0,
  `volumn` int(4) NOT NULL DEFAULT 0,
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `carriage_info` (`idx`, `cid`, `cNo`, `pNum`, `air`, `volumn`, `timestamp`) VALUES
(1, 168, 1, 1, 20, 50, '2023-07-28 18:25:03'),
(2, 168, 2, 2, 20, 50, '2023-07-28 18:25:04'),
(3, 168, 3, 3, 20, 50, '2023-07-28 18:25:04'),
(4, 168, 1, 21, 21, 21, '2023-07-29 11:00:57'),
(5, 168, 1, 19, 21, 21, '2023-08-01 10:28:42'),
(6, 168, 2, 29, 21, 21, '2023-08-01 10:28:42'),
(7, 168, 3, 45, 21, 21, '2023-08-01 10:28:42'),
(8, 133, 1, 30, 34, 34, '2023-08-05 14:01:41'),
(9, 133, 2, 45, 34, 34, '2023-08-05 14:01:41'),
(10, 133, 3, 67, 34, 34, '2023-08-05 14:01:41'),
(11, 133, 2, 18, 34, 34, '2023-08-05 14:04:58');
...
--
ALTER TABLE `access_signal`
  MODIFY `idx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
